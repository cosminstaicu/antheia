<?php
namespace Antheia\Framework\Classes\Input;
/**
...
abstract class NewInput {
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputButton
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputCheckbox
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputColor
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputCustomButton
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputDate
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputEmail
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputFile
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputFileDrop
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputInfo
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputNewPassword
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputNumber
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputPassword
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputPhone
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputReset
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputSearch
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputSelect
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputSubmit
	 * @return InputSelect the new input that has been created
	 */
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputText
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputTextarea
	 ...
	 * @see \Antheia\Framework\Classes\Input\InputTime
