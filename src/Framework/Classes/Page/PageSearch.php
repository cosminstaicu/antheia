...
use Antheia\Framework\Classes\Input\AbstractInput;
use Antheia\Framework\Classes\Input\InputSubmit;
use Antheia\Framework\Classes\Panel\PanelInput;
...
class PageSearch extends PageEmpty {
	 ...
	 * @return \Antheia\Framework\Classes\Form the form that will be submitted,
	 * when the user pressed the submit button
	 */
	public function getForm():\Antheia\Framework\Classes\Form {
		return $this->form;
	}
	/**
	 * Returns the panel used to display inputs
	 * @return \Antheia\Framework\Classes\Panel\PanelInput the panel used to
	 * display inputs
	 */
	public function getPanel():\Antheia\Framework\Classes\Panel\PanelInput {
		return $this->panel;
	}
	/**
	 * Defines the input that will get focus after the page has been loaded
	 * @param \Antheia\Framework\Classes\Input\AbstractInput $input the input
	 * that will get focus after the page has been loaded or null if no autofocus
	 * is needed
	 */
	public function setAutofocus(
			?\Antheia\Framework\Classes\Input\AbstractInput $input):void {
