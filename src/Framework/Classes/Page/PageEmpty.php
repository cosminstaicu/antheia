<?php
namespace Antheia\Framework\Classes\Page;
use Antheia\Framework\Classes\Form;
...
use Antheia\Framework\Classes\FixedButton\AbstractFixedButton;
use Antheia\Framework\Classes\Header\Header;
use Antheia\Framework\Classes\Header\Search\TopSearch;
use Antheia\Framework\Classes\Header\Tabs\HeaderTab;
use Antheia\Framework\Classes\Header\TopRightMenu\AbstractTopRightMenu;
...
class PageEmpty extends PageBlank {
	 ...
	 * \Antheia\Framework\Classes\Header\Header::TYPE_FIXED (default)
	 * the page title, along with the page manu (if available) will align with
	 * a fixed wireframe
	 * \Antheia\Framework\Classes\Header\Header::TYPE_FLUID the page title will always
	 * be on the left edge of the document
	 * @see \Antheia\Framework\Classes\Header\Header::setType()
	 * @param string $type
	 */
	 ...
	 * @see \Antheia\Framework\Classes\Header\Header::setBackgroundImage()
	 */
	 ...
	 * @return \Antheia\Framework\Classes\Wireframe\Wireframe the added wireframe
	 */
