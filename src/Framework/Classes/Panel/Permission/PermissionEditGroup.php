<?php
namespace Antheia\Framework\Classes\Panel\Permission;
use Antheia\Framework\Classes\Input\InputSelect;
use Antheia\Framework\Classes\Panel\Panel;
use Antheia\Framework\Classes\Wireframe\WireframeInput;
/**
...
class PermissionEditGroup extends Panel {
	...
	/**
	 * @see \Antheia\Framework\Classes\Panel\AbstractPanel::setTitle()
	 */
