<?php
namespace Antheia\Framework\Classes\Table\Plain;
...
implements TableRow {
	...
	public function addCell(TableCell $cell = NULL):TableCell {
		...
		if (!is_a($cell, 'Antheia\Framework\Classes\Table\Plain\Cell')) {
			throw new Exception(
				'Only Antheia\Framework\Classes\Table\Plain\Cell instances allowed'
			);
		}
		$this->cells[] = $cell;
		return $cell;
