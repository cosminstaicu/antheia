<?php
namespace Antheia\Framework\Page;
...
use Antheia\Framework\FixedButton\AbstractFixedButton;
use Antheia\Framework\Header\Header;
use Antheia\Framework\Header\Search\TopSearch;
use Antheia\Framework\Header\Tabs\HeaderTab;
use Antheia\Framework\Header\TopRightMenu\AbstractTopRightMenu;
use Antheia\Framework\Icon\IconVector;
use Antheia\Framework\Menu\Item\AbstractMenu;
...
class PageEmpty extends PageBlank {
	 ...
	 * \Antheia\Framework\Header\Header::TYPE_FIXED (default)
	 * the page title, along with the page manu (if available) will align with
	 * a fixed wireframe
	 * \Antheia\Framework\Header\Header::TYPE_FLUID the page title will always
	 * be on the left edge of the document
	 * @see \Antheia\Framework\Header\Header::setType()
	 * @param string $type
	 */
	 ...
	 * @see \Antheia\Framework\Header\Header::setBackgroundImage()
	 */
	 ...
	 * @return \Antheia\Framework\Wireframe\Wireframe the added wireframe
	 */
