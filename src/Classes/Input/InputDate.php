...
use Antheia\Framework\Input\Raw\InputRawCustomButton;
use Antheia\Framework\Interfaces\BeforeAfterCallback;
/**
...
class InputDate extends AbstractInput implements BeforeAfterCallback {
	...
	public function getHtml():string {
		...
		if (!is_file($ajaxFile)) {
			...
			$content = '<?php require_once(\''.dirname(__DIR__, 2).'/Scripts/Php/date.php\'); ?>';
