 ...
 */
function jsf_utils_changePageTitle(title) {
 ...
 */
function jsf_utils_showPageMenu() {
	let menu = document.querySelector(".jsf_menu");
	if (menu !== null) {
		menu.classList.add("jsf-active");
	}
}
/**
 * Hides the page menu container
 */
function jsf_utils_hidePageMenu() {
	let meniu = document.querySelector(".jsf_menu");
	if (meniu !== null) {
		meniu.classList.remove("jsf-active");
	}
}
/**
 ...
 */
function jsf_utils_showPageMenuItem(id) {
	document.getElementById(id).classList.remove("jsf-hidden");
}
/**
 * Hides a page menu item
 * @param {String} id the id of the menu to be hidden
 */
function jsf_utils_hidePageMenuItem(id) {
	document.getElementById(id).classList.add("jsf-hidden");
}
/**
 ...
 */
function jsf_utils_preCallback(input) {
	jsf_utils_inputCallback(input, 'pre');
}
/**
 ...
 * @param {Element} input the input to be checked
 */
function jsf_utils_postCallback(input) {
	jsf_utils_inputCallback(input, 'post');
}
/**
 ...
 */
function jsf_utils_inputCallback(input, action) {
 ...
 */
function jsf_utils_checkCompatibility() {
	let newClass = new jsf_alert();
	newClass.setButtonLabel('Just a test');
	if (document.getElementById('jsf_compatibilityScript') !== null) {
		setTimeout(() => {
			document.getElementById('jsf_compatibilityScript').remove();
		}, 1000);
	}
}