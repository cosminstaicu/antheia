...
use Antheia\Framework\Classes\Theme\ThemeWarmRustic;
...
$page->setTheme(new ThemeWarmRustic());
$page->setTitle('Warm rustic theme');
...
<a href="https://www.schemecolor.com/warm-rustic-color-palette.php" target="_blank">Scheme Color</a>.
</p>');
