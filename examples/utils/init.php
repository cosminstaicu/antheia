...
function init_configurePage(AbstractPage $page):void {
	...
	$submenu->setHref('../05_search');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('text_list_bullets');
	$submenu->setText('Results');
	$submenu->setHref('../05_search/results.php');
	$menu->addSubmeniu($submenu);
	$page->addNavigationMenu($menu);
	// confirmation messages
	$menu = new AppMenuPrimary();
	$menu->setText('Confirm messages');
	$menu->setHref('../06_confirmation');
	$menu->setIcon('tooltip');
	$page->addNavigationMenu($menu);
	// loading animations
	$menu = new AppMenuPrimary();
	$menu->setText('Loading');
	$menu->setHref('../07_loadingAnimation');
	$menu->setIcon('clock_select_remain');
	$page->addNavigationMenu($menu);
	// tabs
	$menu = new AppMenuPrimary();
	$menu->setText('Tabs');
	$menu->setHref('../08_tabs');
	$menu->setIcon('tab');
	$page->addNavigationMenu($menu);
	// modal
	$menu = new AppMenuPrimary();
	$menu->setText('Modal');
	$menu->setHref('../09_modal');
	...
	$submenu->setHref('../10_themes/default.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Dark aesthetics');
	$submenu->setHref('../10_themes/darkAesthetics.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Dusk');
	$submenu->setHref('../10_themes/dusk.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Retro Orange Gray');
	$submenu->setHref('../10_themes/retroOrangeGray.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Soft Warm');
	$submenu->setHref('../10_themes/softWarm.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Warm Rustic');
	$submenu->setHref('../10_themes/warmRustic.php');
	$menu->addSubmeniu($submenu);
	$submenu = new AppMenuSecondary();
	$submenu->setIcon('color_swatches');
	$submenu->setText('Custom');
	$submenu->setHref('../10_themes/custom.php');
	$menu->addSubmeniu($submenu);
	$page->addNavigationMenu($menu);
}
/**
